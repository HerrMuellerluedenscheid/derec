...
if __name__ ==  "__main__":
    ...
    if test_type == 'castor':
        ...
        plot_depths=num.arange(1000., 9000.,1000.)
    ...
    z, p, k = butter(4, [0.60*num.pi*2, 5.0*num.pi*2.],
                       'band',
                       analog=True,
                       output='zpk')
    ...
    #test_case_setup.percentage_of_shift= 20.
    test_case_setup.time_shift= 0.2
    ...
    test_case.scaling_factors = num.arange(0.1, 2., 0.05)
    ...
    plt.gcf().savefig('doctar_misfits.pdf', 
              ...
              pad_inches=0.01)
    plt.figure()
    ob.stack_plot(depths=plot_depths)
    f = plt.gcf()
