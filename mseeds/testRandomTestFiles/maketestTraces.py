...
t1 = trace.Trace(network='1-', station='TE', channel='Z', deltat=0.5, tmin=tmin, ydata=data1)
t2 = trace.Trace(network='1-', station='TE', channel='N', deltat=0.5, tmin=tmin, ydata=data2)
