...
if __name__ ==  "__main__":
    ...
    note = 'rs'
    false_store_id = None#'doctar_mainland_20Hz'
    ...
    location_test_sources_lists = du.make_lots_of_test_events(_ref_source, depths, 
            {'strike':[60., 60], 'dip':0., 'rake':[60.,60.], 'north_shift':0.,
                'east_shift': 0.}, 
            num_tests,
            func='uniform') 
    i=0
    ...
    for location_test_sources in location_test_sources_lists:
        ...
        param1= best_source.rake
        param2= best_source.strike
        results.append([param1, param2, best_misfit, got_it])
