...
if __name__ ==  "__main__":
    ...
    targets = du.stations2targets(stations, store_id, measureq='')
    ...
    zmin=store.config.source_depth_min
    zmax=store.config.source_depth_max
    dz = store.config.source_depth_delta
    depths = drange(zmin, zmax, dz)
    print depths
